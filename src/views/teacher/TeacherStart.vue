...
<template>
    ...
    <div class="card-container">
        <el-card class="left-card">
            ...
            <el-timeline>
                <el-timeline-item v-for="a in announcements" :key="a.id" :timestamp="a.publishTime">{{ a.title
                }}</el-timeline-item>
            </el-timeline>
        ...
        <el-card class="right-card">
            ...
            <el-timeline>
                <el-timeline-item v-for="e in exams.slice(0, 4)" :key="e.id" :timestamp="e.startTime">{{ e.examName
                }}</el-timeline-item>
            </el-timeline>
        </el-card>
    </div>
    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span style="font-weight: bold;">我创建的考试</span>
                <el-link style="color: #5965C9;" href="/teacher/exam" :underline="false">查看全部 > </el-link>
            </div>
        </template>
